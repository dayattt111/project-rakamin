...
.product-card {
  background: #FFFFFF;
  border-radius: 16px;
  box-shadow: 0 10px 40px rgba(114, 0, 96, 0.12);
  display: flex;
  max-width: 900px;
  width: 100%;
  overflow: hidden;
  border: 1px solid rgba(114, 0, 96, 0.08);
}
...
.product-image {
  ...
  justify-content: center;
  padding: 60px 40px;
  border-right: 1px solid rgba(114, 0, 96, 0.06);
}
...
.btn-primary:hover {
  ...
  box-shadow: 0 8px 24px rgba(114, 0, 96, 0.35);
}
